            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/dashboard2"
                  ...
                  <span className="overflow-hidden text-ellipsis whitespace-nowrap">Register a Service</span>
              ...
              <li>
                <a href="/add-availability"
                  ...
                  <span className="overflow-hidden text-ellipsis whitespace-nowrap">Your Availability</span>
                  <svg xmlns="http://www.w3.org/2000/svg"
                    className="arrowIcon w-3 fill-current -rotate-90 ml-auto transition-all duration-500"
                    viewBox="0 0 451.847 451.847">
                    <path
              ...
              <li>
                <a href="#"
                  ...
                  <span className="overflow-hidden text-ellipsis whitespace-nowrap">Bookings</span>
                  <svg xmlns="http://www.w3.org/2000/svg"
                    className="arrowIcon w-3 fill-current -rotate-90 ml-auto transition-all duration-500"
                    viewBox="0 0 451.847 451.847">
                    <path
              ...
              <li>
                <a href="#"
                  ...
                  <span className="overflow-hidden text-ellipsis whitespace-nowrap">My Services</span>
                  <svg xmlns="http://www.w3.org/2000/svg"
                    className="arrowIcon w-3 fill-current -rotate-90 ml-auto transition-all duration-500"
                    viewBox="0 0 451.847 451.847">
                    <path
            ...
            <div className="mt-6">
              ...
              <ul className="mt-3 space-y-2">
                ...
                <li>
                  <a href="#"
                    className="text-gray-800 text-sm flex items-center cursor-pointer hover:bg-gray-100 rounded-md px-3 py-2.5 transition-all duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" className="w-[18px] h-[18px] mr-3"
